  ...
  >
    <div class="relative rounded-2xl overflow-hidden"
      style="
        ...
        box-shadow: 0 0 0 1px rgba(255,255,255,0.04), 0 30px 80px rgba(0,0,0,0.5), 0 0 60px rgba(0,102,255,0.08), inset 0 1px 0 rgba(255,255,255,0.06);
      ...
      <div class="flex items-center gap-2 px-5 py-3"
        ...
        <span class="ml-auto text-xs" style="color: rgba(255,255,255,0.15); font-family: monospace;">astroblox.app</span>
      </div>
          ...
          {#each features as feat}
            <div class="flex flex-col items-center justify-center gap-5 px-12 text-center"
              ...
              <div class="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl"
                style="background: rgba(0,102,255,0.12); border: 1px solid rgba(0,102,255,0.2); box-shadow: 0 0 30px rgba(0,102,255,0.12);">
                {feat.icon}
              </div>
              <div>
      ...
      <div class="flex items-center justify-center gap-4 py-4"
        ...
        <button onclick={() => { prev(); resetInterval(); }}
          ...
          style="background: rgba(255,255,255,0.04); color: #4b5263;" aria-label="Previous feature"
        ...
        <div class="flex items-center gap-2">
          {#each features as _, i}
            <button onclick={() => goTo(i)} aria-label="Go to feature {i + 1}"
        ...
        <button onclick={() => { next(); resetInterval(); }}
          class="w-7 h-7 rounded-full flex items-center justify-center transition-all duration-200 border-0 cursor-pointer"
          style="background: rgba(255,255,255,0.04); color: #4b5263;" aria-label="Next feature"
          onmouseenter={(e) => e.currentTarget.style.background='rgba(0,102,255,0.15)'}
          onmouseleave={(e) => e.currentTarget.style.background='rgba(255,255,255,0.04)'}>
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
    ...
    <div class="absolute -bottom-8 left-1/2 -translate-x-1/2 w-3/4 h-8 pointer-events-none"
      style="background: rgba(0,102,255,0.12); filter: blur(20px); border-radius: 50%;"></div>
  </div>
